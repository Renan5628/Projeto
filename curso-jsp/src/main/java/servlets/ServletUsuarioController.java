...
public class ServletUsuarioController extends ServletGenericUtil {
	...
	try {	
				 ...
				 ModelLogin modelLogin = super.getUserLogadoObjt(request);
				 
				 if(modelLogin.isNovo()) {
					 
					 RequestDispatcher redirecionar = request.getRequestDispatcher("/index.jsp");
						request.setAttribute("msg", "Servidor foi reiniciado, favor insira o login novamente!");
				 ...
				 if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
					 ...
					 response.getWriter().write(json);
					    ...
					    String id = request.getParameter("id");
					     ...
					     modelLogin = daoUsuarioRepository.consultaUsuarioID(id, super.getUserLogado(request));
					 
					     List<ModelLogin> modelLogins = daoUsuarioRepository.consultaUsuarioList(super.getUserLogado(request));
					     request.setAttribute("modelLogins", modelLogins);
					     
					    request.setAttribute("msg", "Cadastro sendo atualizado.");
					 ...
					 modelLogin =  daoUsuarioRepository.consultaUsuarioID(idUser, super.getUserLogado(request));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (daoUsuarioRepository.validarLogin(modelLogin.getLogin()) && modelLogin.getId() == null ) {
			msg = "Ops! Existe cadastro com o mesmo login, favor informe outro login.";
			 ...
			 request.getRequestDispatcher("principal/usuario.jsp").forward(request, response);
					...
					if (modelLogin.isNovo()) { 
					     ...
					     }else if (modelLogin.getLogin().equalsIgnoreCase(daoUsuarioRepository.consultaUsuarioID(modelLogin.getId()).getLogin())) {
								    ...
								    modelLogin = daoUsuarioRepository.gravarUsuario(modelLogin, super.getUserLogado(request));
					    	 		...
					    	 		if(daoUsuarioRepository.validarLogin(modelLogin.getLogin())) {
					    	 			...
					    	 			msg = "Login ja cadastrado, favor insira um novo.";
										 
									    modelLogin = daoUsuarioRepository.consultaUsuarioID(modelLogin.getId());
										...
										request.getRequestDispatcher("principal/usuario.jsp").forward(request, response);
					    	 			...
					    	 			msg = "Cadastro foi atualizado, com um login novo!";
